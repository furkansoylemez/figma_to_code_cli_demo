...
import 'generated/components/status_badge/example.dart';
...
class ComponentCatalogHome extends StatelessWidget {
  final List<ComponentItem> components = [
    ComponentItem(
      name: 'StatusBadge',
      description: 'Status indicator badges for various states',
      icon: Icons.label,
      page: StatusBadgeExamplePage(),
    ),
    ComponentItem(
      name: 'BaseTag',
      description: 'Basic tag components for categorization',
      icon: Icons.tag,
